...
Release 2 should be committed as a new versioned milestone and should not replace the v1.0.0 public baseline.
...
Release 2 still uses mock data only.

The following are outside the current scope:

- Backend integration
- Authentication
- Real wearable device data
