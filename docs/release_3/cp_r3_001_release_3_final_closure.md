...
Release 3 is fully implemented and ready for GitHub publishing preparation.
...
Release 3 adds a complete Wellness Goals page to the CarePulse Flutter Dashboard.

The page is now a full dashboard section focused on:
...
The release is ready for the next publishing step after project owner approval.
...
Release v1.2.0: add Wellness Goals dashboard page
Closure Decision
