...
This document records the layout foundation for the Wellness Goals page in Release 3.
...
The layout uses a clean dashboard-style card structure with soft spacing, rounded corners, and a wellness-focused green accent.

Current Status

This stage intentionally uses placeholder content.
