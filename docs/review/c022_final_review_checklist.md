...
- [ ] No real medical diagnosis logic is included.

---

## Asset Review

- [ ] No original Dribbble screenshot is included.
- [ ] No third-party logo is included.
- [ ] No copied design asset is included.
- [ ] No unsafe image asset is included.
...
- [ ] README.md exists.
- [ ] README.md explains the educational purpose.
- [ ] README.md explains that all data is mock data.
- [ ] README.md explains that this is not a real medical system.
- [ ] README.md includes how to run the project.
- [ ] README.md includes quality check commands.
- [ ] C001 to C022 documentation exists.
